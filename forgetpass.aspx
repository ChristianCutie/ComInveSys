                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                 <center>
                            <img src="https://www.zamboanga.com/z/images/9/90/PH_seal_bulacan.png" alt="" width="250" height="250" style=" margin-top: 3em;"/>
                        </center>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        <div class="mb-3">
                                         ...
                                         <asp:Button ID="repass" class="btn btn-primary btn-user btn-block" runat="server"  Text="Reset Password" > </asp:Button>
