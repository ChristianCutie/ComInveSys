<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPITO2.master" AutoEventWireup="true" CodeFile="BPC_Accomplishment_Admin.aspx.cs" Inherits="Admin_Admin_PITO_2_BPC_Accomplishment_Admin" %>
    ...
    <form style="margin-left: 2em; background-color: white;" id="form1" action="/" method="post">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h2 style="margin-left: 1em; margin-top: 1em;" class="text-gray-700 mb-0">Accomplishment Request</h2>
            </div>
        </div>
        <section class="pt-0">
                                    ...
                                    <div class="example" style="height: 420px; overflow-x: auto;">  
                                        <asp:GridView Width="100%" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="StickyHeader text-center" GridLines="Horizontal" BorderStyle="None" ID="grv" CssClass="table table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="ID">
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField Text="Manage" ItemStyle-ForeColor="LightGreen" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="PVOManageAdmin.aspx?ID={0}" />
                                            </Columns>
