<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPITO2.master" AutoEventWireup="true" CodeFile="PendingAccount.aspx.cs" Inherits="Admin_Admin_PITO_2_PendingAccount" %>
    ...
    <asp:ScriptManager runat="server" />
     <form style="margin-left: 2em; background-color: white;" id="form1" action="/" method="post">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <h2 style="margin-left: 1em; margin-top: 1em;" class="text-gray-700 font-weight-normal mb-0">Pending Accounts</h2>
         </div>
        <section class="pt-0">
