<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPITO2.master" AutoEventWireup="true" CodeFile="CreateAccountAdmin.aspx.cs" Inherits="Admin_Admin_PITO_2_CreateAccountAdmin" %>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group ">
                                   <asp:DropDownList Style="border-radius: 10px;" CssClass="form-control bg-white border-gray-500 mb-4 dropdown-toggle" ID="ddlpos" runat="server">
                                            ...
                                            <asp:ListItem Text="Computer Technician" />
