<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPITO.master" AutoEventWireup="true" CodeFile="InventoryItem.aspx.cs" Inherits="s" %>
        ...
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div id="hidebtn" runat="server">
                    <asp:LinkButton ID="btnAdd" runat="server" CssClass="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm mt-5" OnClick="btnAdd_Click">
               <small class="fa fa-plus text-white"> Add New Item</small></asp:LinkButton>
                </div>
                <div id="cancelbtn" visible="false" runat="server">
                    <asp:LinkButton ID="cancel" runat="server" CssClass="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm mt-5" OnClick="cancel_Click">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="m-0 font-weight-normal text-black-50">Inventory</h3>
                                         <asp:Button CssClass="btn btn-info" ID="prnt" Text="Print" runat="server" OnClick="prnt_Click" />
                                    </div>
                                    <div class="col-md-6">
                                        <div class=" ms-2 d-flex w-50 float-end">
                                            ...
                                            <asp:LinkButton runat="server" CssClass="btn btn-secondary fa-magnifying-glass fa-solid p-2 w-auto " ID="btnsearch" OnClick="btnsearch_Click"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body bg-light">
                                <div class="table-responsive ">
                                    <div class="example" style="height: 420px; overflow-x: auto;">  
                                        ...
                                        <asp:GridView Width="100%" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="StickyHeader text-center" BorderStyle="None" ID="grv" CssClass="table table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="id">
                                            <Columns>
                                                <asp:BoundField DataField="Processor" HeaderText="Processor" SortExpression="Processor" />
                                                <asp:BoundField DataField="RAM" HeaderText="RAM_1    " SortExpression="RAM" />
                                                <asp:BoundField DataField="RAM2" HeaderText="RAM_2   " SortExpression="RAM2" />
                                                <asp:BoundField DataField="Storage" HeaderText="Storage_1" SortExpression="Storage" />
                                                <asp:BoundField DataField="Storage2" HeaderText="Storage_2" SortExpression="Storage2" />
                                                <asp:BoundField DataField="Storage3" HeaderText="Storage_3" SortExpression="Storage3" />
                                                <asp:BoundField DataField="Storage4" HeaderText="Storage_4" SortExpression="Storage4" />
                                                <asp:BoundField DataField="GraphicCard" HeaderText="Graphics_Card" SortExpression="GraphicCard" />
                                                <asp:BoundField DataField="PSU" HeaderText="Power_Supply" SortExpression="PSU" />
            ...
            <div class="container-fluid">
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class=" form-group ">
                                                ...
                                                <asp:LinkButton Style="margin-top: -.7em;" ToolTip="Add new item" CssClass=" mb-1 fas fa-plus-circle text-lg text-secondary float-end" ID="lnkram" runat="server" OnClick="lnkram_Click" />
                                            </div>
                                            ...
                                            <div class=" form-group ">
                                                ...
                                                <asp:LinkButton Style="margin-top: -.7em;" ToolTip="Add new item" CssClass=" mb-1 fas fa-plus-circle text-lg text-secondary float-end" ID="lnkstorage" runat="server" OnClick="lnkstorage_Click"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                    ...
                    <div class="card-footer bg-white border-0">
                        ...
                        <asp:Button ID="btnsubmit" CssClass="btn btn-success float-end" Text="Submit" runat="server" OnClick="btnsubmit_Click"/>
                    </div>
                        </div>
                    </div>
                </div>
