<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPITO.master" AutoEventWireup="true" CodeFile="pending_distribute_to_client.aspx.cs" Inherits="PVOPendingRequestAdmin" %>
                                    ...
                                    <div class="example" style="height: 420px; overflow-x: auto;">  
                                        <asp:GridView Width="100%" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="StickyHeader text-center" GridLines="Horizontal" BorderStyle="None" ID="grv" CssClass="table table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="ID">
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField Text="Manage" ItemStyle-ForeColor="LightGreen" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="manage_distribute_to_client.aspx?ID={0}" />
                                            </Columns>
