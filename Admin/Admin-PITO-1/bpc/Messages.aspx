    ...
    <section class="p-0">
       ...
       <script type="text/javascript">
           ...
           function send_message() {
               ...
               xmlhttp.open("GET", "admin_to_bpc-message.aspx?FirstName=" + username + "&messages=" + document.getElementById("t1").value, true);
               xmlhttp.send();
           ...
           function load_messages() {
               ...
               xmlhttp.open("GET", "load_messages_bpc.aspx?FirstName=" + username, true);
               xmlhttp.send();
           }
           load_messages();
