<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPITO.master" AutoEventWireup="true" CodeFile="bpc_request_from_client.aspx.cs" Inherits="Admin_Admin_PITO_1_PVORequestAdminPITO" %>
    ...
    <form style="margin-left: 2em; background-color: white;" id="form1" action="/" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h4 class="float-end mt-md-4">Bulacan Polytechnic College</h4>
                </div>
            </div>
        </div>
