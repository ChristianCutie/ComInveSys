...
public partial class Admin_Admin_PITO_1_PVOAccomplishmentAdmin : System.Web.UI.Page
{
    ...
    private void show()
    {
        if (Session["uname"] != null)
        {
            ...
            {
                Response.Redirect("Admin/Admin-PITO-1/PVO_Accomplishment_Admin.aspx");
                dr.Close();
            }
    ...
    {
        SqlCommand cmd = new SqlCommand("SELECT * FROM PVOAccomplishmentDB", con);
