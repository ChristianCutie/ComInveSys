...
public partial class Admin_Admin_PITO_1_load_new_messages : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlCommand cmd = new SqlCommand("SELECT * FROM communicationTB WHERE ddepartment = 'Admin' AND Status='Active'", con))
        {
            cmd.ExecuteNonQuery();
