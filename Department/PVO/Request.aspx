<%@ Page Title="" Language="C#" MasterPageFile="~/ClientPage.master" AutoEventWireup="true" CodeFile="Request.aspx.cs" Inherits="Department_PVO_Request" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="tbl" runat="server" class="card bg-light shadow">
                            ...
                            <div class="card-body">
                                <h3 class=" mb-2 font-weight-normal text-black-5 ">User Information</h3>
                    ...
                    <div class="card-footer bg-white border-0">
                        ...
                        <asp:Button ID="btnsubmit" OnClientClick="return confirm('Are you sure want to Save?')" CssClass="btn btn-success float-end" OnClick="btnsubmit_Click" Text="Submit" runat="server"/>
                    </div>
                        </div>
                    </div>
                </div>
        ...
        <center>
            <div runat="server" visible="false" id="reponsemesage">
                <div style="width: 500px; height: 270px" class="card mt-3 bg-white border-left-success shadow-lg p-3">
                    ...
                    <br />
                    <asp:LinkButton ID="viewtb" Text="View Table" runat="server" OnClick="viewtb_Click" />
                </div>
            </div>
        </center>
