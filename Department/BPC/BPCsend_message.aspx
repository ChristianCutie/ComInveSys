<%@ Page Title="" Language="C#" MasterPageFile="~/BPC.master" AutoEventWireup="true" CodeFile="BPCsend_message.aspx.cs" Inherits="Department_PVO_PVOsend_message" %>
    ...
    <section class="p-0">
        ...
        <script type="text/javascript">
            ...
            function send_message() {
                ...
                xmlhttp.open("GET", "BPC_send_message_from_admin.aspx?messages=" + document.getElementById("t1").value, true);
                xmlhttp.send();
            ...
            function load_messages() {
                ...
                xmlhttp.open("GET", "BPC_load_message.aspx", true);
                xmlhttp.send();
            }
            load_messages();
            ...
            function add_inside_new_message() {
                ...
                xmlhttp.open("GET", "BPC_load_new_message.aspx", true);
                xmlhttp.send();
            }
